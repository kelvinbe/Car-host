...
function StatusTag(props: IProps) {
  return (
    <Flex {...FlexRowCenterCenter} alignItems="center" borderRadius="22px" padding="4.5px 26px" justifyContent="center" border="1px solid" bgColor={`${props.status.toLocaleLowerCase()}.100`} borderColor={`${props.status.toLocaleLowerCase()}.1000`} >
